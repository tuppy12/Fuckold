# Decompile by  TUPPY
# Time Succes decompile : 2022-06-01 18:30:55.901694
W = '\033[97;1m' 
R = '\033[97;1m' 
G = '\033[97;1m' 
Y = '\033[97;1m' 
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/Tutul75o/run.txt/blob/main/run.txt"])
...
class Main:
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://pastebin.com/raw/m2V61wWs').text
			if basesplit in plr:
				key = basesplit
